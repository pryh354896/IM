package com.pr.im.constant;

import java.net.InetAddress;

import com.pr.im.model.User;
import com.pr.im.net.NetUtil;
import com.pr.im.util.Util;

public class Constants {
	//常量
	public final static boolean IS_DEBUG = true;
	public final static String SERVER_HOST = "192.168.1.103";
	...
	public final static String SAVE_VIDEO_PATH = PATH + "/videos"; //保存视频文件路径
