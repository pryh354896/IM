...
import com.pr.im.R;
import com.pr.im.adapter.ChatAdapter;
import com.pr.im.constant.Constants;
import com.pr.im.constant.MyApplication;
import com.pr.im.d3View.D3Activity;
import com.pr.im.d3View.D3View;
import com.pr.im.d3View.MyListView;
import com.pr.im.d3View.RecordButton;
import com.pr.im.d3View.MyListView.OnRefreshListener;
import com.pr.im.d3View.RecordButton.OnFinishedRecordListener;
...
import com.pr.im.xmppView.expression.ExpressionListener;
import com.pr.im.xmppView.expression.ExpressionView;
...
//				Tool.initToast(getApplicationContext(), adr);
	...
	public void onClick(View v){
		...
		case R.id.takePicBtn:    //拍照
			...
			intent1.putExtra("type", PicSrcPickerActivity.CHOOSE_VIDEO);
...
//			Intent intent3 = new Intent(Intent.ACTION_PICK,MediaStore.Video.Media.EXTERNAL_CONTENT_URI);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		if (RESULT_OK == resultCode) {
			...
			case PicSrcPickerActivity.CROP:
				...
				break;
				case VideoActivity.VID:
					String videoname = data.getStringExtra("videoName");
					String base6String = data.getStringExtra("base64String");
					System.out.println(base6String+"======================");
					if (videoname != null) {
						try {
							XmppConnection.getInstance().sendMsgWithParms(videoname, new String[]{"videoData"}, new Object[]{base6String},chatType);
						} catch (Exception e) {
							autoSendIfFail(videoname,new String[]{"videoData"}, new Object[]{base6String});
							e.printStackTrace();
						}
					}
					break;
